...
osnap_section_coords = np.hstack((lats,lons))
print(osnap_section_coords)
quit()
...
#plotting
p1 = ax.pcolormesh(mask.nav_lon_grid_T.to_numpy(), mask.nav_lat_grid_T.to_numpy(), np.transpose(mask.to_numpy()), transform=ccrs.PlateCarree(), cmap=cm)
