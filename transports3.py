...
def transport_calculations(runid, endyear, endmonth, endday, startyear=2004, startmonth=1, startday=5):
    figs_path = '/home/rowan/projects/rrg-pmyers-ad/rowan/NEMO-analysis-Graham/pics_transports/' #'/project/6007519/weissgib/plotting/figs/transports/'
    ...
    dv = xr.open_mfdataset(mdl_files_v, data_vars='minimal', coords='minimal', compat='override')
    du = xr.open_mfdataset(mdl_files_u, data_vars='minimal', coords='minimal', compat='override')
    dt = xr.open_mfdataset(mdl_files_t, data_vars='minimal', coords='minimal', compat='override')
    ...
    volume_transport.to_netcdf(figs_path+section+'_volume_transport_'+runid+'TEST.nc')
    freshwater_transport.to_netcdf(figs_path+section+'_freshwater_transport_'+runid+'TEST.nc')
    heat_transport.to_netcdf(figs_path+section+'_heat_transport_'+runid+'TEST.nc')
    salt_transport.to_netcdf(figs_path+section+'_salt_transport_'+runid+'TEST.nc')
