...
plt.title('Heat content in the LS convection region, EPM152')
plt.ylabel('Heat content (TJ)')
plt.xlabel('Time')
plt.savefig('temp-EPM152_HC_convectiveRegion.png', dpi=1200, bbox_inches="tight")
plt.close()
...
plt.legend()
plt.xticks(rotation=45)
plt.title('Average surface temperature in the LS convection region, EPM152')
plt.ylabel('Temperature (degrees Celsius)')
plt.xlabel('Time')
plt.savefig('temp-EPM152_Temperature_convectiveRegion.png', dpi=1200, bbox_inches="tight")
plt.close()
